          ...
          <form onSubmit={handleJoinGame} className="space-y-4" role="form" aria-label="Join game form">
            ...
            >
              ...
              <input
                ...
                maxLength={6}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-center text-lg font-mono tracking-widest transition-all"
                required
            ...
            >
              <fieldset>
                ...
                <div className="grid grid-cols-2 gap-2" role="radiogroup" aria-labelledby="team-selection">
                  {teams.map((team, index) => (
                    <motion.button
                      key={team.id}
                      type="button"
                      onClick={() => setSelectedTeam(team.id)}
                      className={`p-3 rounded-lg border-2 transition-all focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
            ...
            <motion.button
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 px-4 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
